...
public class ProfileActivity extends AppCompatActivity implements DecodeCompleteListener, 
	    ...
	    protected void onPostExecute(String access_token) {
	        ...
	        if (access_token != null) {
	        	...
	        	if(type.equals("upload_image")){
		        	...
		        	mImageUploader.uploadBitmap(mBitmap, url, access_token);
	        	}
	...
	private void loadProfile(){
		...
		mImageLoaderRounded.mImageFetcherRounded.loadImage(mAccountManager.getUserData(acc[mAccPos], AccountGeneral.KEY_IMAGE_URL), mAvatarImage);
	}
	...
	public void getUploadCompleteState(HashMap<String, String> result) {
		...
		if(result.get("error") != null){
			...
			mImageLoaderRounded.mImageFetcherRounded.loadImage(result.get("image_url"), mAvatarImage);
