...
public class TreeElement  implements TreeElementI{
	...
	public TreeElement(String id, String icon, String outlineTitle, boolean hasParent, int hasChild, TreeElement parent, int level, boolean expanded) {
	    super();
	    this.childList = new ArrayList<TreeElementI>();
	    this.id = id;
	    this.Icon = icon;
	    ...
	    if(parent != null)
	    {
	        this.parent.getChildList().add(0,this);
	    }
	    this.level = level;
