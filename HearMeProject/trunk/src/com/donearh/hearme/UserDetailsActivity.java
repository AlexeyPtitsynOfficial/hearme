...
public class UserDetailsActivity extends AppCompatActivity implements ConnectionCallbacks,OnConnectionFailedListener, GetJSONListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageLoaderRounded = new ImageLoaderRounded(UserDetailsActivity.this, ImageLoader.DIR_USER_AVATAR);
        ...
        mImageLoaderRounded.mImageFetcherRounded.loadImage(image_url, mAvatarImage);
	...
	public void onRemoteCallComplete(JSONObject obj, View v) {
		...
		try {
			...
			new CustomToast(UserDetailsActivity.this).showErrorToast("Œ¯Ë·Í‡");
			e.printStackTrace();
		}
