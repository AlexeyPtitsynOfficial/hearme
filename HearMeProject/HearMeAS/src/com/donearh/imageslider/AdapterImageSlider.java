...
ViewPager.OnPageChangeListener{
	...
	public static ArrayList<String> mSliderImages;
	...
	public ArrayList<String> setData(ArrayList<String> data)
	{
	...
	public Fragment getItem(int position) {
		...
		Fragment currentFragment =  FragmentImageHolder.newInstance(mContext, position, mSliderImages.get(position), IsBlured);
