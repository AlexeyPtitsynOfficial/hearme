...
public class SavedData
{
	...
	private static String SELECTED_CATS_FILTER_TEXT = "selected_cats_filter_text";
	...
	public void saveSelectedCats(String filter_text, ArrayList<Integer> cats){
		Editor editor = mPrefs.edit();
		try
		{
			editor.putString(SELECTED_CATS_FILTER_TEXT, filter_text);
	...
	public String getSelectedCatsFilterText(){
		return mPrefs.getString(SELECTED_CATS_FILTER_TEXT, "");
	}
