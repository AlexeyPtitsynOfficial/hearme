...
public class StartAppFragment extends Fragment implements AnimationListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		/*int[] color = {getResources().getColor(R.color.primary),getResources().getColor(R.color.accent)};
		float[] position = {0, 1};
		Shader.TileMode tile_mode = Shader.TileMode.CLAMP;
		LinearGradient lin_grad = new LinearGradient(0, 0, 0, 100,color,position, tile_mode);
		Shader shader_gradient = lin_grad;

		app_name.getPaint().setShader(shader_gradient);*/
		//Anim
